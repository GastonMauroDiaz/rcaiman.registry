...
#'
#' @param projection_coef numeric vector. Polynomial coefficients of the lens
#'   projection function (relative radius as a function of `theta`, radians).
...
#'
#' @export
calc_diameter <- function(projection_coef, radius, angle) {
  ...
  Rfor90 <- calc_relative_radius(90, projection_coef)
  RforMyAngle <- calc_relative_radius(angle, projection_coef)
