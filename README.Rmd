...
A registry snapshot can be exported as a YAML file to be distributed
as metadata alongside preprocessed images.
...
rcaiman.registry.data     → registry entries maintained by the *rcaiman.registry* maintainer
